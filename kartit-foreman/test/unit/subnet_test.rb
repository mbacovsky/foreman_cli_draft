...
describe KartitForeman::Subnet do
  ...
  context "ListCommand" do
    ...
    let(:cmd) { KartitForeman::Subnet::ListCommand.new("") }
  ...
  context "InfoCommand" do
    ...
    let(:cmd) { KartitForeman::Subnet::InfoCommand.new("") }
  ...
  context "CreateCommand" do
    ...
    let(:cmd) { KartitForeman::Subnet::CreateCommand.new("") }
  ...
  context "DeleteCommand" do
    ...
    let(:cmd) { KartitForeman::Subnet::DeleteCommand.new("") }
  ...
  context "UpdateCommand" do
    ...
    let(:cmd) { KartitForeman::Subnet::UpdateCommand.new("") }
